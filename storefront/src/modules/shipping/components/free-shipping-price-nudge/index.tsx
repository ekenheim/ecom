      ...
      <div className="space-y-1.5">
        <div className="flex justify-between text-xs text-neutral-600">
          ...
          <div
            className={twMerge(
              "visible",
              price.target_reached && "opacity-0 invisible"
            )}
          >
            Only{" "}
  ...
  return (
    <div
      className={twMerge(
        ...
        price.target_reached && "opacity-0 invisible delay-1000",
        isClosed && "opacity-0 invisible",
        !price.target_reached && !isClosed && "opacity-100 visible"
      )}
    >
      <div>
        <button
          className="rounded-full bg-neutral-900 text-white p-2 flex items-center justify-center"
      ...
      <div className="w-[400px] bg-black text-white p-6 rounded-lg">
        ...
        <div className="flex gap-3">
          <LocalizedLink
            className="rounded-2xl bg-transparent border border-white text-[15px] py-2.5 px-4 text-white"
            href="/cart"
          >
            View cart
          </LocalizedLink>
          ...
          <LocalizedLink
            className="flex-grow rounded-2xl bg-white text-neutral-950 border border-white text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedLink>
